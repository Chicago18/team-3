 ...
 */
$config['site_title']                 = "MCAA";       // Site Title, example.com
$config['admin_email']                = "admin@mcaa.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['teacher_group']              = 'teacher';             // Default teachers group, use name
$config['student_group']              = 'students';             // Default students group, use name
$config['parent_group']               = 'parent';             // Default parent group, use name
